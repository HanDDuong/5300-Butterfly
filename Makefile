# Makefile, Kyle Fraser, Seattle University, CPSC 5300, Spring 2022
#
...
# Note that this is the default target since it is the first non-generic
# one in the Makefile: make
sql5300: $(OBJS)
